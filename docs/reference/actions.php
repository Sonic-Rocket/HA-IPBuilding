<?php
/**
 * ARCHIVED REFERENCE — IPBuilding mobile web API router
 *
 * Source: Spark Mail attachment cache (user-provided), preserved for documentation.
 * Original path on controller: /mobile/core/actions.php
 * Archived: 2026-06-01
 *
 * This file is NOT executed by Home Assistant. See docs/mobile-api.md for analysis.
 */
